...
$(this).draggable("com.shsxt.crm.proxy").css({left:-10000,top:-10000});
...
if(d>3){
$(this).draggable("com.shsxt.crm.proxy").show();
}
this.pageY=e.pageY;
},onStopDrag:function(){
...
var _2f=$(_2d).draggable("com.shsxt.crm.proxy").find("span.tree-dnd-icon");
