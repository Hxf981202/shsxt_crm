...
var _12=_e.proxy;
if(!_12){
if(com.shsxt.crm.proxy){
if(com.shsxt.crm.proxy=="clone"){
_12=$(e.data.target).clone().insertAfter(e.data.target);
}else{
_12=com.shsxt.crm.proxy.call(e.data.target,e.data.target);
}
_e.proxy=_12;
}else{
_12=$(e.data.target);
